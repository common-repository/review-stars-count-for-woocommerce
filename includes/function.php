...
class wooPsr {
        ...
        if( $woospr ){
            if ($woospr['enabled'] == "yes")
            {
                if ($woospr['single_enable'] == "yes") {
                    ...
                    add_action('admin_enqueue_scripts', array($this, 'woopsr_admin_scripts'));
    ...
    public function check_required_plugins( $plugin ) {
        if (!is_plugin_active('woocommerce/woocommerce.php')) {
            ...
            <?php
            deactivate_plugins('/review-stars-count-for-woocommerce/woo-star-count.php');
        }
    }
    ...
    public function woopsr_admin_scripts() {
        wp_enqueue_style('custom-star-rating-css-admin', plugin_dir_url(__FILE__) . 'css/custom-star-rating-admin.css');
    }
